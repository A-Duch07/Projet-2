...
import { SelectionLassoAttributeComponent } from './selection-lasso-attribute.component';

describe('SelectionLassoAttributeComponent', () => {
    let component: SelectionLassoAttributeComponent;
    let fixture: ComponentFixture<SelectionLassoAttributeComponent>;
    let selectionLassoSpy: jasmine.SpyObj<SelectionLassoService>;
    ...
    beforeEach(async(() => {
        ...
        selectionLassoSpy = jasmine.createSpyObj('SelectionLassoService', ['onKeyDown']);
        TestBed.configureTestingModule({
            declarations: [SelectionLassoAttributeComponent],
            providers: [
                { provide: SelectionLassoService, useValue: selectionLassoSpy },
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SelectionLassoAttributeComponent);
