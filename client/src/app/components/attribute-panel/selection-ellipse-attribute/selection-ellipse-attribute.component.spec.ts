...
import { SelectionEllipseAttributeComponent } from './selection-ellipse-attribute.component';

describe('SelectionEllipseAttributeComponent', () => {
    let component: SelectionEllipseAttributeComponent;
    let fixture: ComponentFixture<SelectionEllipseAttributeComponent>;
    let drawingStub: DrawingService;
    let canvasTestHelper: CanvasTestHelper;
    let baseCtxStub: CanvasRenderingContext2D;
    let previewCtxStub: CanvasRenderingContext2D;
    let undoRedoStub: UndoRedoService;
    let selectionEllipseSpy: jasmine.SpyObj<SelectionEllipseService>;
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            declarations: [SelectionEllipseAttributeComponent],
            providers: [
                { provide: SelectionEllipseService, useValue: selectionEllipseSpy },
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SelectionEllipseAttributeComponent);
